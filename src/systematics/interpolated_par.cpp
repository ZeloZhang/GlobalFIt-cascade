...
NuFit::interpolated_par::interpolated_par(std::string par_name_, std::vector<std::string> analysis_names_)
{
	...
	analysis_names = analysis_names_;
        ...
        basedir=std::string("/data/ana/analyses/diffuse/cascades/analysis_code/input/default/myc/");
        basedir_mlb = std::string("/data/ana/analyses/diffuse/cascades/analysis_code/input/default/mlb/");
